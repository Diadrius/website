  ...
  return (
    <footer className="bg-soft-green-light border-t border-gray-200 py-8">
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-start text-text-light">
        ...
        <div className="flex flex-col items-start text-left mb-6 md:mb-0">
          <p className="mb-1 text-sm text-gray-700">Praktijklocatie: <a href="https://maps.app.goo.gl/VT4pkto5SEC7Yzxt8" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-ocher transition-colors underline">Het Gebouw, Rotterdam</a></p>
