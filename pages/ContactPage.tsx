      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-lg text-text-light leading-8">
            Zet de eerste stap door contact op te nemen voor een gratis en vrijblijvend kennismakingsgesprek. Vul het onderstaande formulier in, of stuur direct een e-mail. Ik neem zo snel mogelijk contact met je op.
          </p>
        </div>
