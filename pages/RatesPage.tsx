      ...
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <div className="bg-soft-green-light p-8 rounded-xl border border-soft-green">
         ...
         <div className="text-center pt-4">
              <Link to="/kennismakingsgesprek" className="inline-block bg-ocher hover:bg-ocher-dark text-white font-semibold font-serif py-3 px-8 rounded-full shadow-lg transition-transform transform hover:scale-105 duration-300">
